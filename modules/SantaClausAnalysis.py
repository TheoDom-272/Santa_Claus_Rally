...
class statistics():
    ...
    def T_test(self,santa_claus_df,other_df):
        """ Performs a T-test between two DataFrames."""
    ...
    def Mann_Whitney_test(self,santa_claus_df,other_df):
        """ Performs a Mann-Whitney test between two DataFrames."""
    ...
    def OLS_regression2(self, santa_claus_df, other_df, numeric: bool = False):
        """A method that will perform the OLS regression presented in the paper and manage the display to"""
    ...
    def OLS_variants(self, santa_claus_df, other_df, numeric: bool = False):
        """A method that will perform the OLS regression variants presented in the paper and manage the display to"""
    ...
    def bootstrap(self, santa_claus_df, other_df, n_iterations=1000, alpha=0.05, numeric: bool = False):
        """A method that will perform the bootstrap and manage the display to"""
