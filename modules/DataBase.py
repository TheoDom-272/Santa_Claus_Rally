...
class YahooFinanceAPI:
    """Data import class, based on the requested Yahoo Finance ticker, start date, and end date."""
    ...
    def fetch_prices(self,export_data: bool = True):
        """Fetches adjusted closing prices for the specified tickers and date range from Yahoo Finance."""
        try:
            data = yf.download(
            ...
            if close_prices.empty:
                raise ValueError("Error while retrieving data..")
    ...
    def export_to_excel(self, df):
        """Exports the DataFrame to an Excel file with a name based on the tickers and dates."""
        try:
            ...
            print(f"Data successfully exported to the file. : {file_path}")
        except Exception as e:
...
class DataCompute(YahooFinanceAPI):
    """Class that manages the data, builds price and return DataFrames."""

    def __init__(self, tickers, start_date, end_date,export_data: bool = True):

        super().__init__(tickers, start_date, end_date) #Call the constructor of the parent class
    ...
    def compute_data_dict(self):
        """Creates a dictionary with tickers as keys and their corresponding price and return DataFrames as values."""
    ...
    def compute_return(self,df):
        ...
        df_result = df.pct_change(fill_method=None)
    ...
    def modif_df(df,start_date,end_date):
        """Modifies the DataFrame to keep only data within the specified date range."""
...
class FactorsDataBase:
    """Class that manages the import and formatting of factor data from an Excel file."""
    ...
    def load_data(self):
        """Loads data from the specified Excel file and sheets into a dictionary of DataFrames."""
    ...
    def format_data(self):
        """Formats the loaded factor data by setting the date as index, dropping unnecessary columns, and filtering by date range."""
